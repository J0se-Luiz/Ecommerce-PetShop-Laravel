...
@section('titulo','Editar Registrar')
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-3 offset-md-4">
                                <button type="submit" class="btn btn-search btn-login" style="color: white">
                                    Registrar
                                </button>
                            </div>
                            <div class="col-m-4">
                                <a href= " {{ __('login')}}" class="btn btn-search" style="color: white">
                                    Já tenho cadastro
                                 </a>
                            </div>
                        </div>
